...
namespace Unity.LiveCapture.Networking.Protocols
{
    ...
    sealed class TextureSender : DataSender<TextureData>
    {
        ...
        /// or the message is not a <see cref="TextureSender"/>.</exception>
        public static TextureSender Get(Protocol protocol, string id)
        {
            if (protocol == null)
                throw new ArgumentNullException(nameof(protocol));

            return protocol.GetDataSender<TextureData, TextureSender>(id);
        }
