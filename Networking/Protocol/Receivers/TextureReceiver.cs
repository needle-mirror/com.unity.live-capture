...
namespace Unity.LiveCapture.Networking.Protocols
{
    ...
    sealed class TextureReceiver : DataReceiver<TextureData>
    {
        ...
        /// or the message is not a <see cref="TextureReceiver"/>.</exception>
        public static TextureReceiver Get(Protocol protocol, string id)
        {
            if (protocol == null)
                throw new ArgumentNullException(nameof(protocol));

            return protocol.GetDataReceiver<TextureData, TextureReceiver>(id);
        }
